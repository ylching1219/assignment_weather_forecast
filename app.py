...
def result_text(probability):
    ...
    if probability >= 0.70:
        return {
            "label": "🌧️ High chance of rain",
            "desc": "Rain is likely. Bringing an umbrella is a good idea.",
            "class_name": "rainy",
            "pct": pct
        }
        ...
        return {
            ...
            "desc": "Conditions are mixed. Light rain or showers may happen.",
            "class_name": "cloudy",
            "pct": pct
        }
    return {
        "label": "☀️ Low chance of rain",
        "desc": "Weather looks mostly dry based on the current inputs.",
        "class_name": "sunny",
        "pct": pct
    }
